<template>
  <el-container>
    <el-header>
      <el-menu :default-active="(activeIndexComputed+1).toString()" class="el-menu-demo"
        ...
        <el-submenu index="4" v-if="userinfo">
          ...
          <el-menu-item index="2-4-1">修改个人信息</el-menu-item>
  ...
  computed: {
    childernRoutes() {
      ...
      for (var i = 0; i < route.length - 1; i++) {
        routes = routes.find((e) => e.name === route[i].name)
      }
